...
background in cinematography, in order to generate a consistent list of
...
described below, were determined and entered into a table. A total of XXX
passes were performed in order to validate the annotation.

% THIS SOUNDS LIKE IT SHOULD BE SOMEWHERE,  BUT NOT HERE
%If the camera switched settings within a scene, names  were adjusted
%accordingly.
