...
% evtl. koennte bei den folgenden 2 todos folgendes passen:
% irgendwie will ich fuer die MA mit inkscape noch ein Bild zusammenschustern, in dem
% Schnitte mit setting, locale, und perspective change deutlich werden.
% dieses um ein Bsp. fuer major location switch zu ergaenzen ist 
% nach entsprechendem Skillerwerb sicherlich kein Problem.
% Ausserdem: die Skripte fuer meine Bedingungen kann ich so umschreiben, 
% dass man Mdn & SD fuer Shot-laengen nach major, setting, locale und perspective
% switches inkl. stacked histogramm bekommt.
...
\todo[inline]{this section could be stripped of all FSL/MRI references
  ...
  what is there.}
% dazu habe ich ein paar Fragen, weshalb ich es - zumal es sich mit der MA
% parallel wenig ueberschneidet - noch offen gelassen habe.
